      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Lottie.asset("assets/otp.json", width: 300, height: 150, ),
              const SizedBox(
                height: 10,
              ),
              const Text("Verify Your Email" , style: TextStyle(color: Colors.black , fontSize: 30 , fontWeight: FontWeight.w500,)),
              const SizedBox(height: 10,),
              const Padding(
                padding: EdgeInsets.only(left: 20.0 , right: 20.0),
                child: Text("Please Enter The 4 Digit Code Sent to Your Email " , style: TextStyle(color: Colors.black54 , fontSize: 18 ) , textAlign: TextAlign.center,),
              ),
              const SizedBox(
                height: 30,
              ),
